...
contract SpliteNumber{
    ...
    function splitNumber() public { // number split function
        ...
        uint256 number2 = (number - val1) / 1000; // Subtract val1 from number and divide by 1000. this allows us to delete the last 3 digits of the main number.
        val2 = number2 % 1000; // We find the remainder again from dividing the remainder number2 by 1000.

        uint256 number3 = (number2 - val2) / 1000;
        val3 = number3 % 1000;
    }
}  
